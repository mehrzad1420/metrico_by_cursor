(function () {
  ...
  const STR = {
    ...
    fa: {
      ...
      "feat.title": "میتریکو چه امکاناتی دارد؟",
      "feat.sub":
      ...
      "about.lead":
        "میتریکو یک پلتفرم مدیریت پروژهٔ ساختمانی برای سازندگان، پیمانکاران، سرمایه‌گذاران و تیم فروش است — کسانی که چند پروژه، واحد، خریدار و دفتر مالی را هم‌زمان دنبال می‌کنند.",
      "about.p1":
      ...
      "about.baseP":
        "میتریکو را به‌عنوان نرم‌افزار مقیاس‌پذیر می‌سازیم: جذب نیروی تخصصی برای مهندسی و فروش بین‌المللی، تکمیل صورتحساب آمادهٔ اروپا، و عمق‌بخشی ماژول‌های انرژی، مصالح و بینش بازار.",
