const CACHE_NAME = "metrico-cache-v2.50.6";
const ASSETS = [
  ...
  "./guide/plans.svg", "./guide/start.svg", "./guide/finance.svg", "./guide/accounting.svg",
  "./guide/inventory.svg", "./guide/energy.svg", "./guide/takeoff.svg", "./guide/owner_portal.svg",
  "./guide/contracts.svg", "./guide/project_maps.svg", "./guide/map.svg"
];
